...
// import { FileText, Calculator, ArrowRight, Zap, Shield, Download } from 'lucide-react'
...
//               No sign-up. No watermarks. Just open and use.
//             </p>

//             <div className="flex flex-wrap gap-3 animate-fade-up" style={{ animationDelay: '0.3s', opacity: 0 }}>
//               <Link href="/tools/invoice-generator" className="btn-primary gap-2 px-6 py-3 text-base">
...
//             Start with these tools today. No account, no credit card.
//           </p>
//         </div>

//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
//           {TOOLS.map(tool => (
//             <Link key={tool.href} href={tool.href} className="tool-card group p-5 flex flex-col gap-4">
...
//                 Open tool <ArrowRight size={13} className="group-hover:translate-x-0.5 transition-transform" />
//               </div>
//             </Link>
//           ))}
...
//             No account required. Download professional PDFs in seconds.
//           </p>
//           <Link href="/tools/invoice-generator" className="btn-primary gap-2 px-8 py-3 text-base inline-flex">
...
import Link from 'next/link'
import { FileText, Calculator, Clock, ArrowRight, Zap, Shield, Download } from 'lucide-react'
import { Navbar } from '@/components/layout/Navbar'
import { Footer } from '@/components/layout/Footer'
