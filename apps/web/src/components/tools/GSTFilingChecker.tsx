...
import {
  ...
  MapPin, Search, FileText, BarChart2,
} from 'lucide-react'
...
export function GSTFilingChecker() {
          ...
          {(phase !== 'idle' || captchaImg) && (
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  type="button"
                  onClick={() => { if (validation.valid) loadCaptcha(gstin) }}
        ...
        <div className="space-y-4 animate-fade-up">
          {result.gstin && result.sts ? (
            <>
              ...
              {/* Filing section — the whole point of this tool */}
              {filingSessionId && (
                <FilingSection
