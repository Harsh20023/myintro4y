...
export default function MobileBottomBar() {
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 md:hidden flex h-[52px] shadow-2xl"
    ...
    >
      <a
        ...
        className="flex-1 flex items-center justify-center gap-2 text-white text-sm font-bold"
        style={{ backgroundColor: 'var(--ca-whatsapp)' }}
      >
        {/* WhatsApp icon */}
